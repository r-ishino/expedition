...
| 3      | Jira API連携（課題取得）     | 中     | タスクの入口                                                                                                               |
| 4      | PR作成・レビュー状態の可視化 | 中     | タスクの出口                                                                                                               |
| 5      | CI失敗の自動検知・自動修正   | 高     | PoC-2の延長で実装可能                                                                                                      |
| 6      | Jira課題からのタスク細分化   | 高     | プロンプト調整が主。技術的にはAPI呼び出しのみ                                                                              |
| 7      | 通知・アラート               | 低     | SSE基盤はPoC-2で構築済み                                                                                                   |
| 8      | 実行ログ・コスト管理         | 低     | 運用が始まってから                                                                                                         |
